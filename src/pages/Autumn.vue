<template lang="pug">
  q-page.container#autumn
    .row.q-my-md
      .col-3
      router-link.col(to="/spring" style="text-decoration: none;")
        h6.text-center.text-dark.q-mb-sm 春季
      router-link.col(to="/summer" style="text-decoration: none;")
        h6.text-center.text-dark.q-mb-sm 夏季
      router-link.col(to="/autumn" style="text-decoration: none;")
        h6.text-center.text-primary.q-mb-sm 秋季
      router-link.col(to="/winter" style="text-decoration: none;")
...
export default {
  ...
  async mounted () {
    try {
      const { data } = await api.get('/festivals/season/3')
